...
class Cpu():
    ...
    def tick(self):
        ...
        for i in range(opcount):
            self.decoded_inst += " " + str(self.ram[pc+1+i])
        # Execute
        inc_pc = execute()
    ...
    def inst_illegal(self):
        self.inst_halt("Illegal instruction")
        return False
    def inst_halt(self):
        self.inst_halt("Program Halted")
        return True
    def inst_nop(self):
        return True
    def inst_speed(self):
    ...
    def inst_copylr(self):
        self.ram[self.ram[self.pc + 2]] = self.ram[self.pc + 1]
        return True
    def inst_copyla(self):
        self.accu = self.ram[self.pc + 1]
        return True
    def inst_copyar(self):
        self.ram[self.ram[self.pc + 1]] = self.accu
        return True
    ...
    def inst_copyrr(self):
        value = self.ram[self.ram[self.pc + 1]]
        self.ram[self.ram[self.pc + 2]] = value
        self.status_Z(value)
        return True
    def inst_addla(self):
