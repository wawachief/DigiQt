...
:index 
  ...
  btstss	zeroFlag statusReg // digits are equal? 
  jump	noMatch 
:match 
  incr	correctPlace 
:index2 
...
:innerComparLoop 
  ...
  btstss	zeroFlag statusReg // if ZeroFlag=1, match 
  jump	noMatch2 
